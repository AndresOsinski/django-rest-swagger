...
class SwaggerResourcesView(APIDocView):
    ...
    def get_resources(self):
        ...
        apis = urlparser.get_apis(
            urlconf=urlconf, exclude_namespaces=SWAGGER_SETTINGS.get('exclude_namespaces'),
            exclude_names=SWAGGER_SETTINGS.get('exclude_names'))
...
class SwaggerApiView(APIDocView):
    ...
    def get_api_for_resource(self, filter_path):
        urlparser = UrlParser()
        urlconf = getattr(self.request, "urlconf", None)
        return urlparser.get_apis(urlconf=urlconf, filter_path=filter_path, exclude_names=SWAGGER_SETTINGS.get('exclude_names'))
